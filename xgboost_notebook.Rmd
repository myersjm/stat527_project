...
The most important variable by far is `week`, followed by `lag4` and `lag1`. The stores were not imporant, which makes sense because we standardized the weekly sales by store before running the algorithm, so the effect of the store was not captured.
